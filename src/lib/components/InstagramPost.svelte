...
<div class="relative h-full w-full">
	<a href={post.permalink} target="_blank">
		...
		<div>
			...
			<img
				...
				class={(large
					...
					' bg-colorstackuf-blue rounded-full absolute tablet:left-4 bottom-4 z-20'}
			/>
		</div>
		...
		>
			<div class="relative opacity-0 group-hover:opacity-100 transition-opacity duration-500">
				<p
					class={(large
